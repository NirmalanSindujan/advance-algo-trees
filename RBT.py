...
class RedBlackTree:
    ...
    def height(self):
        """Calculate the height of the tree using the root."""
        return self._height(self.root)

    def _height(self, node):
        """Helper method to calculate height recursively."""
        if node == self.NULL:  # Base case: if it's a NULL sentinel, return 0
            return 0
        
        # Recursively calculate the height of left and right subtrees and return max + 1 for current node
